...
module.exports = EntityGenerator.extend({
    ...
    configuring : {
        ...
        LoadInMemoryData: function() {
            ...
            this.entityFileName = _s.trim(_s.dasherize(this.name), '-');
    ...
    writing : {
        ...
        writeClientFiles: function() {
            ...
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management.html', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-detail.html', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-detail.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-dialog.html', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-dialog.html', this, {}, true);
            this.copyHtml(ANGULAR_DIR + 'entities/_entity-management-delete-dialog.html', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-delete-dialog.html', this, {}, true);

            this.addEntityToMenu(this.entityInstance + '-management', this.enableTranslation);

            this.template(ANGULAR_DIR + 'entities/_entity-management.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management.js', this, {});
            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management.js');
            this.template(ANGULAR_DIR + 'entities/_entity-management.controller.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management.controller' + '.js', this, {});
            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management.controller' + '.js');
            this.template(ANGULAR_DIR + 'entities/_entity-management-dialog.controller.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-dialog.controller' + '.js', this, {});
            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-dialog.controller' + '.js');
            this.template(ANGULAR_DIR + 'entities/_entity-management-delete-dialog.controller.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-delete-dialog.controller' + '.js', this, {});
            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-delete-dialog.controller' + '.js');

            this.template(ANGULAR_DIR + 'entities/_entity-management-detail.controller.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-detail.controller' + '.js', this, {});

            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-detail.controller' + '.js');

            this.template(ANGULAR_DIR + 'services/_entity.service.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '.service' + '.js', this, {});
            this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '.service' + '.js');

            if (this.searchEngine == 'elasticsearch') {
                this.template(ANGULAR_DIR + 'services/_entity-search.service.js', ANGULAR_DIR + 'entities/' + this.entityFileName + '-management/' + this.entityFileName + '.search.service' + '.js', this, {});
                this.addJavaScriptToIndex('entities/' + this.entityFileName + '-management/' + this.entityFileName + '.search.service' + '.js');
            }
        ...
        writeClientTestFiles: function () {
            ...
            this.template('src/test/javascript/spec/app/entities/_entity-management-detail.controller.spec.js',
                'src/test/javascript/spec/app/entities/' + this.entityFileName + '-management/' + this.entityFileName + '-management-detail.controller.spec.js', this, {});
        },
